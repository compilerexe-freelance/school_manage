...
class Admin_model extends CI_Model{
    ...
    foreach ($query->result() as $row) {
      ...
      echo "
            <td style='padding-top:35px;'>
                ...
                <a href='".base_url()."index.php/main/info_learn_search?text_search=".$row->id_student."'><img src='".base_url()."assets/images/icon/info.png' alt='ข้อมูลการเรียน' style='cursor: pointer; width: 50px; height: 50px;' /></a>
                <a href='".base_url()."index.php/main/regis_class?id=".$row->id."'><img src='".base_url()."assets/images/icon/register.png' alt='ลงทะเบียนเรียน' style='cursor: pointer; width: 50px; height: 50px;' /></a>
                <a href='".base_url()."index.php/main/member_print?id=".$row->id."' target='_blank'><img src='".base_url()."assets/images/icon/print.png' alt='พิมพ์บัตรสมาชิก' style='cursor: pointer; width: 50px; height: 50px;' /></a>
                <a href='".base_url()."index.php/main/student_detail?id=".$row->id."'><img src='".base_url()."assets/images/icon/infomation.png' alt='รายละเอียด' style='cursor: pointer; width: 50px; height: 50px;' /></a>
                <a href='".base_url()."index.php/main/delete_student?id=".$row->id."'><img src='".base_url()."assets/images/icon/delete.png' alt='ลบ' style='cursor: pointer; width: 50px; height: 50px;' /></a>
    ...
    foreach ($query->result() as $row) {
      echo "
          <tr>
            ...
            <td style='padding-top:35px;'>
                <a href='".base_url()."index.php/main/user_detail?user=".$row->username."'><img src='".base_url()."assets/images/icon/infomation.png' alt='รายละเอียด' style='cursor: pointer; width: 50px; height: 50px;' /></a>
            </td>
          </tr>
      ";
    }
    ...
    foreach ($query->result() as $row) {
      echo "
          <tr>
            ...
            <td>
              <a href='".base_url()."index.php/main/class_detail?search_id=".$row->id."'><img src='".base_url()."assets/images/icon/infomation.png' alt='รายละเอียด' style='cursor: pointer; width: 50px; height: 50px;' /></a>
              <a href='".base_url()."index.php/main/class_delete?id=".$row->id."'><img src='".base_url()."assets/images/icon/delete.png' alt='ลบ' style='cursor: pointer; width: 50px; height: 50px;' /></a>
            </td>
          </tr>
      ";
    }
  ...
  public function get_class_detail() {
    ...
    echo '
    <form action="'.base_url().'index.php/main/db_class_detail" method="post">
  ...
  public function get_student_detail() {
    ...
    echo '
    <form action="'.base_url().'index.php/main/db_student_detail" method="post" enctype="multipart/form-data">
  ...
  public function get_regis_detail() {
    //  $id = $this->input->post('id');
     ...
     $id = ""; $code_class = ""; $title_class = "";

     echo "
     <form action='".base_url()."index.php/main/db_regis_detail' method='post'>
       <div class='table table-responsive'>
         <table class='table borderless text-center' style='border: none !important'>
           <tr>
     ...
     foreach ($query->result() as $row) {
       ...
       $read_select = "[".$code_class."] ".$title_class;
       if ($read_select == $select_class) {
         $id = $row->id;
       }
     }
  ...
  public function db_user_detail() {
    ...
    echo '
    <form action="'.base_url().'index.php/main/db_save_user" method="post" enctype="multipart/form-data">
    ...
    foreach ($query->result() as $row) {
      echo "
          <tr>
            ...
            <td>
                <a href='".base_url()."index.php/main/delete_log?id=".$row->id."'><img src='".base_url()."assets/images/icon/delete.png' alt='ลบ' style='cursor: pointer; width: 50px; height: 50px;' /></a>
            </td>
          </tr>
      ";
    }
