      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <form action='<?php echo base_url(); ?>index.php/main/db_confirm_payment' method='post'>
                ...
                <table class='table borderless text-center' style='border: none !important'>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td>
                          <input type='text' class='form-control' name='price_class' style='width: 100px;' placeholder='จำนวนเงิน'>
                      </td>
                    </tr>
                    <tr>
