  ...
  <div class="row" style="margin-top: 15px;">
    ...
    <div class="col-md-10">
      ...
      <div class="form-group">
        <form action="<?php echo base_url(); ?>index.php/main/regis_class?id=" method="get">
          <?php
            $id = "";
            ...
            <?php
              ...
              foreach ($query->result() as $row) {
                ...
                echo "
                  ...
                  <td>".$payment."</td>
                  <td>
                    <a href='".base_url()."index.php/main/learn_detail?title_class=".$row->title_class."&id_student=".$buff_idstudent."'><img src='".base_url()."assets/images/icon/info.png' alt='' style='cursor: pointer; width:30px;' /></a>
                    <a href='".base_url()."index.php/main/info_learn'><img src='".base_url()."assets/images/icon/delete.png' alt='' style='cursor: pointer; width:30px;' /></a>
                  </td>
                </tr>
                ";
              }
